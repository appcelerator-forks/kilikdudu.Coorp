...
$.configCabecalho = function(status){
	if(status){
		$.headerListaServicos.setHeight(150);
		$.usuario.setHeight(24);
		$.empresa.setHeight(24);
		$.usuario.text = "Usuário: " + Alloy.Globals.Usuario.Nome;
		$.empresa.text = "Empresa: " + Alloy.Globals.Empresa.descricao;
	}
	else{
		$.headerListaServicos.setHeight(98);
		$.usuario.setHeight(0);
		$.empresa.setHeight(0);
		$.usuario.text = "";
		$.empresa.text = "";
...
$.adicionarSecaoServicos = function(Titulo, icone, filhos){
	try{
		...
		for(var i = 0; i < filhos.length; i++){
			...
			tblSection.servicos.push(rowSection);
		}
